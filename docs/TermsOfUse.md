...
1.1 These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (**you**), and **karamem0** (**we, us**), concerning your access to and use of the **SPFxCalendar** (https://github.com/karamem0/spfxcalendar) website as well as any related applications (**the Site**).

The Site provides the following services: **calendar.sppkg** (**Services**). You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions.
...
8.9 In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at [@karamem0](https://twitter.com/karamem0)
