      ...
      this.props.item
        ? <Office.Modal
            ...
            <div className={styles.body}>
              ...
              {
                this.state.allDayEvent && this.state.recurrence
                  ? null
                  : <p>
                      <div className={styles.formlabel}>
                          ...
                          <li>
                            {
                              this.state.recurrence
                                ...
                                : <Office.DatePicker
                                    ...
                                    onSelectDate={(value) => this.setState({ beginDate: new DateTime(this.state.beginDate).setDate(value).toDate() })} />
                            }
                            {
                          ...
                          <li>
                          {
                              this.state.recurrence
                                ...
                                : <Office.DatePicker
                                    ...
                                    onSelectDate={(value) => this.setState({ endDate: new DateTime(this.state.endDate).setDate(value).toDate() })} />
                          }
                          {
                            this.state.allDayEvent
                              ? null
                        ...
                        ? <>
                            <li>
                              ...
                              <div className={styles.pattern}>
                                {
                                  this.state.recurrenceData.repeatOption == 'daily'
                                    ? <Office.ChoiceGroup
                                ...
                                {
                                  this.state.recurrenceData.repeatOption == 'weekly'
                                    ? <>
                                        <div className={styles.flex}>
                                ...
                                {
                                  this.state.recurrenceData.repeatOption == 'monthly'
                                    ? <>
                                        <div className={styles.flex}>
                                ...
                                {
                                  this.state.recurrenceData.repeatOption == 'yearly'
                                    ? <>
                                        <div className={styles.flex}>
